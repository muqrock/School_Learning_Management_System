      ...
      <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            ...
            <h3 class="w3-center">Profil Pengajar</h3>
            <hr class="w3-clear">

<?php
$uname = $_SESSION['Email'];
//select dari database based on email user
$sql = "SELECT Nama, Email, Kp_Mykid, Jantina, Umur, Alamat FROM userguru WHERE Email='$uname' ";
...
<h3 style="background-color: #123456;color: white;">Kategori Pengguna: Guru</h3>
<style>
button[type=submit] {
...
<a href="kemaskiniGuru.php"><button type="submit" name="kemaskini" title="Tekan untuk kemaskini profil anda">Kemaskini Profil</button></a>
