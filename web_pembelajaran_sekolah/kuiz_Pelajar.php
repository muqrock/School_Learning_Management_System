    ...
    <div class="w3-col m3">
      ...
      <div class="w3-card w3-round">
        <div class="w3-white">
          ...
          <a href="profilPelajar.php" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-user-circle fa-fw w3-margin-right"></i>Profil</a></button>
...
$count = 0;
    $res = mysqli_query($conn,"select * from kuiz_subjek order by id DESC");
    ...
    <tr>
        ...
        <td><?php echo $row["Masa"]." Minit"; ?></td>
        <td><button value="<?php echo $row["Tajuk"]; ?>" onclick="set_exam_type_session(this.value);">JAWAB SEKARANG</button></td>
    </tr>
...
function set_exam_type_session(kuiz_subjek){
    var xmlhttp=new XMLHttpRequest();
    xmlhttp.onreadystatechange=function(){
        if(xmlhttp.readyState==4 && xmlhttp.status==200){
            window.location="kuiz_jawab.php";
        }
    };
    xmlhttp.open("GET","forajax/set_exam_type_session.php?kuiz_subjek="+ kuiz_subjek,true);
    xmlhttp.send(null);
    }
</script>
</body>
