...
<html>
<head>
	<title>Hasil Kuiz Yang Lepas</title>
</head>
     <meta charset="UTF-8">
    ...
    <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            ...
            <h3 class="w3-center"><b>Hasil Kuiz Anda Yang Lepas</b></h3>
        <hr class="w3-clear">

<?php
$res=mysqli_query($conn,"select * from kuiz_result where nama_pelajar='$_SESSION[Nama]' order by id desc");
...
if($count==0){
    ...
    echo "<tr>";
        echo "<th>"; echo "Nama Guru"; echo "</th>";
...
while($row=mysqli_fetch_array($res)){
    echo "<tr>";
        echo "<td>"; echo $row["namaGuru"]; echo "</td>";
