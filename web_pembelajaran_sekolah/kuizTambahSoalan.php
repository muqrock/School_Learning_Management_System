...
<div class="w3-container w3-content" style="max-width:1400px;margin-top:80px">    
  ...
  <div class="w3-row">
    ...
    <div class="w3-col m3">
      ...
      <!-- Accordion -->
        <a href="tambahKuiz.php" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-puzzle-piece fa-fw w3-margin-right"></i>Tambah Kuiz</a>
    ...
    <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            ...
            <h3 class="w3-center">Pilih kuiz untuk ditambah soalan</h3>
        <hr class="w3-clear">
...
if(isset($_GET['nota_id'])){
    $padam = $_GET['nota_id'];
      $sql2 = "DELETE FROM kuiz_subjek WHERE id = $padam";
...
$count = 0;
    $res = mysqli_query($conn,"select * from kuiz_subjek where Nama='$_SESSION[Nama]'");
    ...
    <tr>
        ...
        <td><a href="kuizSoalan.php?id=<?php echo $row["id"]; ?>" title="Tekan untuk tambah soalan pada kuiz ini"><button>Pilih Kuiz</button></td>
      ...
      <!-- <div class="w3-row-padding">
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
            <hr class="w3-clear">
        <h3 class="w3-center">" Jika kamu berhasrat untuk</h3>
        <h3 class="w3-center">berjaya, jangan hanya memandang </h3>
        <h3 class="w3-center">ke tangga tetapi belajarlah </h3>
        <h3 class="w3-center">untuk menaiki tangga  </h3>
        <h3 class="w3-center">tersebut. " </h3>
            </div>
          </div>
        </div>
      </div> -->
